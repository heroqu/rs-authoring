 ...
 * import all the page files inside all the locale subdir
 * with one single import statement:
 *
 ...
 * that re-exports all the files from that particular directory, e.g.
